...
This module allows to update your store to a more recent version of PrestaShop. It can used as a CLI tool or with a web assistant.
...
Branch `develop` contains code for future versions of the module, which allow updates from 1.7.x versions to higher.
